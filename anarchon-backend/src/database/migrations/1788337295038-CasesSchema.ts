...
export class CasesSchema1788337295038 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "case_elements" ADD CONSTRAINT "FK_3f3307b4911fd936f05311911f9" FOREIGN KEY ("case_id") REFERENCES "cases"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "case_progress" ADD CONSTRAINT "FK_0987062e9f3d4501aa461b8f2de" FOREIGN KEY ("case_id") REFERENCES "cases"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "case_progress" ADD CONSTRAINT "FK_53a343eb20235ef6e163ae974cc" FOREIGN KEY ("last_location_element_id") REFERENCES "case_elements"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "case_progress" DROP CONSTRAINT "FK_53a343eb20235ef6e163ae974cc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "case_progress" DROP CONSTRAINT "FK_0987062e9f3d4501aa461b8f2de"`,
    );
    await queryRunner.query(
      `ALTER TABLE "case_progress" DROP CONSTRAINT "FK_e94fa75657f716ca78670adfd9e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "case_elements" DROP CONSTRAINT "FK_3f3307b4911fd936f05311911f9"`,
    );
    await queryRunner.query(
